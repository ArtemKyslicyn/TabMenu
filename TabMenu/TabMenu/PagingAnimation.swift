...
enum TurorPageSwipeDirection:CGFloat{
  ...
  class PagingAnimation: NSObject , UIViewControllerAnimatedTransitioning {
...
//        let snapshot = (fromViewController )!.snapshotViewAfterScreenUpdates(true)
//        container.addSubview(toView)
//        container.addSubview(snapshot)
//       
//        let tutorialView = (fromViewController)!.tutorialPageView()
